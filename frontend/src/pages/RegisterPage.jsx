        ...
        <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
            ...
            <div className="flex-1 flex items-center justify-center px-4 py-32 relative">
                ...
                <div className="w-full max-w-md bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-white/20 p-8 relative z-10 animate-in fade-in zoom-in-95 duration-500">
                    ...
                    <p className="text-slate-500 mb-8 font-medium">Join us and start managing leads better.</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        >
                            {isLoading ? <Loader2 className="animate-spin" size={20} /> : 'Register Account'}
                        </button>
                    </form>

                    <p className="mt-8 text-center text-sm font-medium text-slate-500">
                        Already have an account?{' '}
                        <Link to="/" className="text-purple-600 font-bold hover:text-purple-700 hover:underline transition-all">
                            Login here
                        </Link>
                    </p>
                </div>
