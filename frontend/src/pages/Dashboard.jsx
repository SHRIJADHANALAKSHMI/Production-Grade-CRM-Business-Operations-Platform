...
const Dashboard = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto py-8">
            <h1 className="text-3xl font-bold text-slate-800 mb-8">System Dashboard</h1>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center space-x-4">
                    ...
                    <div>
                        <p className="text-sm text-slate-500 font-medium tracking-wide">Converted Leads</p>
                        <p className="text-3xl font-bold text-slate-800">{stats.convertedLeadsCount}</p>
                    </div>
                </div>
            </div>
        </div>
